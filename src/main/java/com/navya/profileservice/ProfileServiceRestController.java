package com.navya.profileservice;
...
public class ProfileServiceRestController
{
    private static final Logger logger = LoggerFactory.getLogger(ProfileServiceRestController.class);
